...
extension ___FILEBASENAMEASIDENTIFIER___: SPUICoordinator {
    ...
    func start(fromController controller: UIViewController?,
        ...
        let vc = ___VARIABLE_productName: identifier___TableControllerView.instantiate(fromStoryboard: UIStoryboard.<#StoryboardName#>, bundle: nil)
        vc.viewModel = ___VARIABLE_productName: identifier___TableControllerViewModel(coordinator: self)
